...
class Missile_3D:
    ...
    def __init__(self, scavel, initPos, initAtt, dt):
        ...
        self.IntegLook_y    = Daseon.Integrator(self.Look.y, dt)
        self.IntegLook_z    = Daseon.Integrator(self.Look.z, dt)
    ...
    def simulate(self, acc):
        ...
        self.Look.y         = self.IntegLook_y.step(-self.att.y)
        self.Look.z         = self.IntegLook_z.step(-self.att.z)
...
class Seeker:
    ...
    def __init__(self, Missile, Target):
        ...
        self.pLook      = copy.deepcopy(self.Missile.Look)
        self.ppLook     = copy.deepcopy(self.Missile.pLook)
    ...
    def seek(self, t):
        ...
        ppLook_buff     = self.ppLook
        pLook_buff      = self.pLook
        ...
        return self.Rvec.mag, self.Look, self.dLOS, self.Missile.scavel,\
                                                    np.array([  normLk(ppLook_buff.y), normLk(pLook_buff.y), normLk(self.Look.y),\
                                                                normLk(ppLook_buff.z), normLk(pLook_buff.z), normLk(self.Look.z)])
